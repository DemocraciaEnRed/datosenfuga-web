      ...
      <div className="app__muestra">
        ...
        <div className="app__muestra-header-obras">
          <div className="app__muestra-header-obras_textos">
            ...
            <p className="text-obras">Un proyecto que reflexiona sobre la privacidad de los datos personales, la gobernanza,  el valor y el uso de los datos, la ciberseguridad y la vida en tiempos de virtualidad. </p>
          </div>
        </div>
        <Sticky/>
