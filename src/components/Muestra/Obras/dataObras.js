export const obras = [
  {
    title: 'Carpeta Fotos',
    autor: 'Florencia Vallejos',
    description: 'Máquinas que recuerdan y personas que olvidan. ¿Por qué es que solo recuerdo los momentos que tengo filmados? Siempre hay algo que le escapa al encuadre del video, y se almacena en un fuera de campo imaginario, que esconde olores, sensaciones, frases, dudas. ¿Cómo vamos a construir nuestra memoria de archivos virtuales? ¿Dónde se almacenan nuestros recuerdos? El registro digital como anclaje a una verdad, que empieza a fallar, cuando el robot también olvida.',
  ...
  {
    title: 'SELF (de la serie DATA/MOOD/SELF)',
    autor: 'Diego Javier Alberti',
    ...
    link: 'http://www.diegoalberti.net/'
  },
  {
    ...
    link: 'https://www.instagram.com/carla_tortul/?hl=es'
  },
  {
    title: 'Calle Vista',
    ...
    autors: {
      autor1: 'Maximiliano Parlagreco',
      autor2: 'Juan Leguizamón',
      autor3: 'Sofia Paz Basail',
    },
    links: {
      linkAutor1: 'https://www.instagram.com/maxparla',
      linkAutor2: 'https://instagram.com/jwanleguizamon',
      linkAutor3: 'https://instagram.com/sofiapazbasail',
    }
  }
]
