...
const Faq = () => {
  return (
    <section className="faq">
      <h2 className="faq__title">¿CÓMO Y A QUÉ PODES REPORTAR?</h2>
      ...
      <p className="faq__description">La Fundación Via Libre se encarga de recibir reportes anónimos sobre fallas de ciberseguridad. Trabajamos para proteger la identidad de quienes nos informan y tomamos medidas para asegurarnos de que se les dé el seguimiento adecuado. En caso de ser relevante, presentamos los informes a organismos competentes, además de explorar mecanismos de reclamo judiciales. Tu seguridad y confidencialidad son nuestra prioridad.</p>
    </section>
  )
}
