    ...
    return (
        <main className='reportes'>
            <header className='reportes__header'>
                ...
                <h2 className='header__subtitle'>¿Encontraste una falla de seguridad y temés reportarla?</h2>
                <a className="header__report-button" href="#reportes__info" type="button">¿Cómo reportar seguro?</a>
            </header>
            <section className='reportes__info' id="reportes__info">
